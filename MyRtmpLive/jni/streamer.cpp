...
void doExecuteVideoViewShow0(JNIEnv * env, jobject obj, jstring sdp) {
	...
	jclass clazz = env->FindClass("com/example/mylive55servermediacodec/StreamerActivity2");
	if (clazz == 0) {
...
JNIEXPORT void JNICALL Java_com_example_mylive55servermediacodec_StreamerActivity2_RtspH264Data
...
JNIEXPORT void JNICALL Java_com_example_mylive55servermediacodec_StreamerActivity2_RtspH264File
...
JNIEXPORT void JNICALL Java_com_example_mylive55servermediacodec_StreamerActivity2_RtspLive
(JNIEnv *env1, jobject obj, jstring filename)
{
	inputFilename = env1->GetStringUTFChars(filename, NULL);
	...
	bool bRet = rtspSender->Init(inputFilename);//fix temp file dir
	if(bRet<0){
...
JNIEXPORT void JNICALL Java_com_example_mylive55servermediacodec_StreamerActivity2_loop(JNIEnv *env,
...
JNIEXPORT void JNICALL Java_com_example_mylive55servermediacodec_StreamerActivity2_end(JNIEnv *env,
		jobject obj) {
